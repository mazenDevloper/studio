...
export function ActiveAzkarWidget() {
  ...
  // Keyed Carousel for immediate re-init on manuscripts change
  ...
  // Ensure carousel updates slides when manuscripts change
  useEffect(() => {
                  ...
                  <div className="animate-in fade-in zoom-in-95 duration-700 w-full h-full flex justify-center items-center p-0 m-0 px-12">
                    {item.type === 'text' ? (
                      ...
                      <img 
                        src={item.content} 
                        alt="Manuscript"
                        className="h-full w-full object-contain p-0 m-0"
