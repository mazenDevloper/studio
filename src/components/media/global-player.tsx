...
export function GlobalVideoPlayer() {
  ...
  return (
    <div 
      className={cn(
        "fixed z-[9999] transition-all duration-1000 ease-[cubic-bezier(0.23,1,0.32,1)] left-1/2 -translate-x-1/2",
        isMinimized 
          ? "bottom-32 w-[650px] h-32 rounded-[2.5rem] liquid-glass cursor-pointer shadow-[0_40px_100px_rgba(0,0,0,0.9)]" 
          : isFullScreen
            ? "inset-0 w-full h-full bg-black flex flex-col translate-x-0 left-0"
